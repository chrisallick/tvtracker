...
ERROR_ALL_TYPES               = [ERROR_INVALID_LOGIN, ERROR_INVALID_API, ERROR_INVALID_NZBID, ERROR_VIP_ONLY, ERROR_DISABLED_ACCOUNT, ERROR_NO_USER,
                                 ERROR_NO_NZB_FOUND, ERROR_NO_SEARCH, ERROR_PEASE_WAIT_X, ERROR_NOTHING_FOUND, ERROR_X_DAILY_LIMIT]
...
class Matrix:
    ...
    def Search(self, query, num="15", catId="", age="", region="", group="", larger="", smaller="", minHits="", maxHits="", maxAge="", englishOnly="1", searchIn=""):
        if not query:
            return False
        data   = {}
